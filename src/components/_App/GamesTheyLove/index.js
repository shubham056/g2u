                            ...
                            <div className="ti-slider-parent">
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-1" data-original="true">
                                    <a href="game/videogametruck.html">
                                        ...
                                        <div className="circle-img"><img src="assets/img/ico-video-theater-2x.png" /></div>
                                        <h3>Video Game Truck</h3>
                                        <p>Play the hottest games in one of our climate controlled mobile game theaters!
                                        </p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-4" data-original="true">
                                    <a href="game/lasertag.html">
                                        ...
                                        <h3>Laser Tag</h3>
                                        <p>Let the battle and fun begin when you throw a laser tag party they'll never
                                            forget!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-3" data-original="true">
                                    <a href="game/hamsterballwracetrack.html">
                                        ...
                                        <p>Combine our popular Hamster Balls with a giant inflatable race track for the
                                            ultimate contest!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-11" data-original="true">
                                    <a href="game/bumperballs.html">
                                        ...
                                        <h3>Bumper Balls</h3>
                                        <p>They’ll have a ball bouncing, flipping &amp; crashing inside their own protective
                                            bubble!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-5" data-original="true">
                                    <a href="game/boogerwars.html">
                                        ...
                                        <h3>Booger Wars</h3>
                                        <p>It's dodgeball meets capture the flag with a twist in a high-energy Games2U
                                            exclusive!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-6" data-original="true">
                                    <a href="game/candycannon.html">
                                        ...
                                        <h3>Candy Cannon</h3>
                                        <p>The perfect way to end your event with a sky-high blast of candy and a
                                            scramble to get yours!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-7" data-original="true">
                                    <a href="game/ulauncher.html">
                                        ...
                                        <h3>U:launcher</h3>
                                        <p>Catapult soft projectiles and water balloons up to 100 yards with the
                                            incredible U:launcher!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-8" data-original="true">
                                    <a href="game/rockwall.html">
                                        ...
                                        <h3>Rock Wall</h3>
                                        <p>It's a test of courage and strength when you scale the mighty wall. How high
                                            can you go?</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-9" data-original="true">
                                    <a href="game/gyroscope.html">
                                        ...
                                        <h3>Gyroscope</h3>
                                        <p>Upside down is downside up and everything in between when you party with our
                                            Gyroscope!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-10" data-original="true">
                                    <a href="game/foammachine.html">
                                        ...
                                        <h3>Foam Machine</h3>
                                        <p>More foam means more fun! It never stops when you throw a foam machine party!
                                        </p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-2" data-original="true">
                                    <a href="game/hamsterball.html">
                                        ...
                                        <h3>Hamster Ball</h3>
                                        <p>End over end you’ll go as you roll around like a human hamster in our giant
                                            inflatable balls!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-12" data-original="true">
                                    <a href="game/bubblesoccer.html">
                                        ...
                                        <div className="circle-img"><img src="assets/img/ico-bubble-ball-2x.png" /></div>
                                        <h3>Bubble Soccer</h3>
                                        <p>It's a bouncing, crashing and smashing good time with our version of the
                                            world's most popular sport!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-13" data-original="true">
                                    <a href="game/gaga.html">
                                        ...
                                        <h3>Gaga</h3>
                                        <p>You'll go gaga competing against each other in a fun and fast-paced game of
                                            single-ball dodgeball.</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-14" data-original="true">
                                    <a href="game/bouncehouses.html">
                                        ...
                                        <h3>Bounce Houses</h3>
                                        <p>From castles to slides and everything in between we've got the inflatables
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-15" data-original="true">
                                    <a href="game/giantwaterslide.html">
                                        ...
                                        <p>Your party will be a summertime sensation when you book our incredible giant
                                            water slide!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-16" data-original="true">
                                    <a href="game/obstaclecourse.html">
                                        ...
                                        <div className="circle-img"><img src="assets/img/ico-obstacle-course-2x.png" /></div>
                                        <h3>Obstacle Course</h3>
                                        <p>Our giant, inflatable obstacle course is an exciting new twist on a
                                            time-tested favorite!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-17" data-original="true">
                                    <a href="game/ubot.html">
                                        ...
                                        <h3>U:bot</h3>
                                        <p>Be the Bot when you step inside and control a giant robot! A Games2U
                                            exclusive event!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-18" data-original="true">
                                    <a href="game/beatthebucket.html">
                                        ...
                                        <div className="circle-img"><img src="assets/img/ico-beat-the-bucket-2x.png" /></div>
                                        <h3>Beat the Bucket</h3>
                                        <p>It's a modern-day dunk tank that's easy to play and hard to resist! Can you
                                            beat the bucket?</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-19" data-original="true">
                                    <a href="game/megascreen.html">
                                        ...
                                        <h3>Mega Screen</h3>
                                        <p>Watch the latest hit movies or play your favorite video game on our 20 foot
                                            mega screen!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-20" data-original="true">
                                    <a href="game/videogamestation.html">
                                        ...
                                        <p>Play any game, any time and anywhere with our mobile big screen video game
                                            stations!</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-21" data-original="true">
                                    <a href="game/bungeejoust.html">
                                        ...
                                        <h3>Bungee Joust</h3>
                                        <p>Who will emerge victorious when you compete in our giant inflatable bungee
                                            joust?</p>
                                ...
                                <div className="col-md-4 col-xs-6 col-ie-4 ti-box game-22" data-original="true">
                                    <a href="game/socialphotobooth.html">
                                        ...
                                        <p>Dress up (or down) and share photos from your event on your favorite social
                                            media accounts!</p>
                        ...
                        <div className="row no-padding limited-width" id="gamesWithIcons">
                            <div className="row">
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/videogametruck.html">
                                            <img src="assets/img/ico-video-game-theater-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/videogametruck.html">
                                            <p>Video Game Truck</p>
                                        </a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/lasertag.html">
                                            <img src="assets/img/ico-laser-tag-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/lasertag.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/hamsterballwracetrack.html">
                                            <img src="assets/img/ico-hamster-ball-w-race-track-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/hamsterballwracetrack.html">
                                            <p>Hamster Ball with Race Track</p>
                                        </a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/bumperballs.html">
                                            <img src="assets/img/ico-bumper-balls-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/bumperballs.html">
                            ...
                            <div className="row">
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/boogerwars.html">
                                            <img src="assets/img/ico-booger-wars-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/boogerwars.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/candycannon.html">
                                            <img src="assets/img/ico-candy-cannon-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/candycannon.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/ulauncher.html">
                                            <img src="assets/img/ico-u-launcher-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/ulauncher.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/rockwall.html">
                                            <img src="assets/img/ico-rock-wall-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/rockwall.html">
                            ...
                            <div className="row">
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/gyroscope.html">
                                            <img src="assets/img/ico-gyroscope-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/gyroscope.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/foammachine.html">
                                            <img src="assets/img/ico-foam-party-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/foammachine.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/hamsterball.html">
                                            <img src="assets/img/ico-hamster-ball-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/hamsterball.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/bubblesoccer.html">
                                            <img src="assets/img/ico-bumper-balls-w-arena-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/bubblesoccer.html">
                            ...
                            <div className="row">
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/gaga.html">
                                            <img src="assets/img/ico-gaga-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/gaga.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/bouncehouses.html">
                                            <img src="assets/img/ico-inflatable-bounce-houses-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/bouncehouses.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/giantwaterslide.html">
                                            <img src="assets/img/ico-inflatable-water-slides-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/giantwaterslide.html">
                                            <p>Giant Water Slide</p>
                                        </a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/obstaclecourse.html">
                                            <img src="assets/img/ico-inflatable-obstacle-course-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/obstaclecourse.html">
                            ...
                            <div className="row">
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/ubot.html">
                                            <img src="assets/img/ico-u-bot-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/ubot.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/beatthebucket.html">
                                            <img src="assets/img/ico-beat-the-bucket-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/beatthebucket.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/megascreen.html">
                                            <img src="assets/img/ico-av-cart-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/megascreen.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/videogamestation.html">
                                            <img src="assets/img/ico-video-game-station-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/videogamestation.html">
                                            <p>Video Game Station</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/bungeejoust.html">
                                            <img src="assets/img/ico-inflatable-bungee-joust-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/bungeejoust.html">
                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/socialphotobooth.html">
                                            <img src="assets/img/ico-social-photo-booth-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/socialphotobooth.html">
                                            <p>Social Photo Booth</p>
                                        </a>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-xs-12 col-ie-3">
                                    <div className="ti-inline-block home-icon">
                                        <a href="game/nerfwar.html">
                                            <img src="assets/img/ico-nerf-battle-blue-2x.png" />
                                        </a>
                                    </div>
                                    <div className="ti-inline-block home-game-name">
                                        <a href="game/nerfwar.html">
