...
const becomeAnAffiliate = ({ page_name, content, page_caption, banner_img, head_title, head_description, bottom_title, bottom_caption, service_one, service_two, service_three, title_after_service, meta_title, meta_description, testimonialsData, investorsData, siteSettingData }) => {
  const SEO = {
    title: meta_title && meta_title != '' ? meta_title : "Become An Affiliate | Games2U",
    ...
    canonical: "https://www.g2u.com/become-an-affiliate",
    openGraph: {
      type: 'website',
      title: meta_title && meta_title != '' ? meta_title : 'Become An Affiliate | Games2U',
      description: meta_description && meta_description != '' ? meta_description : "Information on opening a new franchise of America's most trusted provider of mobile entertainment including video game trucks, laser tag equipment, human hamster balls, and more!",
...
export async function getStaticProps() {
  try {
    const becomeAnAffiliatePayload = { url: `${apiBaseUrl}/content/become-an-affiliate`, method: 'GET' }
    ...
    const ownFranchiseContent = await fetchApi(becomeAnAffiliatePayload); // call become-an-affiliate API
